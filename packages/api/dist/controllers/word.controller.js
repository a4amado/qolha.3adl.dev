...
exports.getWordWithTheLeastClips = exports.appendWord = exports.QueryWord = void 0;
...
function QueryWord(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            return res.status(http_status_codes_1.default.UNPROCESSABLE_ENTITY).send(error);
        }
    });
}
