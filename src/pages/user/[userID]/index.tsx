...
export default function UserPage() {
    return <><Header isSearch={true} /><PageContainer>
        ...
        <Col className="flex flex-col sm:flex-row gap-2 m-2">
            <NextLink className="block w-full"  href="/user/id/words"><Alert showIcon={true} icon={<TfiWrite className="text-3xl"/>}   type="info" message="55 كلمة" /></NextLink>
            <NextLink className="block w-full"  href="/user/id/clips"><Alert showIcon={true} icon={<BiUserVoice  className="text-3xl"/>}   type="info" message="44 صوت" /></NextLink>
        </Col>
    </PageContainer>
    </>
}